//Attach additional responsibilities/behavior to an object dynamically, without altering its class or affecting other instances of the same class. It's a flexible alternative to subclassing for extending functionality.
#include <bits/stdc++.h>
using namespace std;
